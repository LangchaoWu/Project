...
var baseurl = "https://www.googleapis.com/customsearch/v1?key=AIzaSyAdGmCsYFxLVdNB7dNNguOk4t7k9GsreiA&cx=010455093088353511251:8un6u0bs5fk&q=";
...
function selectAll() {
    var results = document.getElementsByClassName("results")[0];
    var numofresult = results.children;
    for (var i = 0; i < numofresult.length; i++) {
	numofresult[i].children[0].checked = true;
    }
...
function deselectAll() {
    ...
    var numofresult = results.children;
    for (var i = 0; i < numofresult.length; i++) {
        numofresult[i].children[0].checked = false;
    }
}
